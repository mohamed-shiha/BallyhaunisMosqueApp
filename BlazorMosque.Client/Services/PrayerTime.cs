...
public class PrayerTimesResult
{
    ...
    public double CalcPercentage(bool showJamaah = true)
    {
        var countUp = new
        {
            ...
            Duration = (Current.IsJamaahPending || !showJamaah ? Now - Current.Time : Now - Current.JamaahTime).TotalSeconds
        };
        ...
        var countDown = new
        {
            ...
            Duration = (Current.IsJamaahPending && showJamaah ? Current.JamaahTime - Now : Next.Time - Now).TotalSeconds + 1
        };
